...
<body>
    ...
    <div class="header">
        ...
        <p style="font-size: 13px; color: #555;">Año: <strong><?php echo e($year); ?></strong></p>
    </div>
        ...
        <tbody>
            <?php $__currentLoopData = $listItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($item['total_pedidos']); ?></td>
                    <td><?php echo e(number_format($item['total_ventas'], 2)); ?></td>
                </tr>
