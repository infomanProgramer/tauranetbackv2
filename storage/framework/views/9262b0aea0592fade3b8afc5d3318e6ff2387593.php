...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php $__currentLoopData = $productoImportePDF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($item->nom_producto); ?></td>
                    <td><?php echo e($item->nom_categoria); ?></td>
                    <td><?php echo e(number_format($item->importe, 2)); ?></td>
                </tr>
