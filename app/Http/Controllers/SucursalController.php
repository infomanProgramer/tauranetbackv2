...
//    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->has('nuevo_numero')){
            $sucursal->nuevo_numero = $request->nuevo_numero;
        }
        if(!$sucursal->isDirty()){
    ...
    public function updateWhatsapp(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nuevo_prefijo' => 'required',
            'nuevo_numero' => 'required',
        ]);
        $validator->setCustomMessages([
            'nuevo_prefijo.required' => 'El prefijo es requerido',
            'nuevo_numero.required' => 'El nuevo número es requerido',
        ]);
